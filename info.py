...
# PyroClient Setup 
API_ID = int(environ['27988117'])
API_HASH = environ['771117c9f555aa7bc6fb9528897df470']
BOT_TOKEN = environ['7482688136:AAFAP2heGBUeLT_Ch7TCR6icFZxGMI-g5Wc']
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('Developeranik', '').split()]
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://masudranaanik:Anikisla1@cluster0.a5gq7xl.mongodb.net/?retrywrites=true&w=majority&appname=cluster0")
